**************************************************************************************
* Programa:    PUBLIS.PRG
* Descripcion: Programa principal de aplicativo de gestión de publicidades
**************************************************************************************
...
Application.Caption="DIARIO LA UNION - Gestión de Publicidades"

CLEAR 
_Screen.WindowState = 2
_Screen.MaxButton = .f.
_Screen.MinButton = .f.
_Screen.Caption = " DIARIO LA UNION - Gestión de Publicidades "
